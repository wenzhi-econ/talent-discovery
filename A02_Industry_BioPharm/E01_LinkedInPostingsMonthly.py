"""
Task:
    Plot the monthly number of LinkedIn postings by BioPharm firms.

Inputs:
    data/b_temp_data/A02_Industry_BioPharm/BioPharm_LinkedInPostings.parquet

Outputs:
    outputs/A02_Industry_BioPharm/E01_LinkedInPostingsMonthly.csv
    outputs/A02_Industry_BioPharm/E01_LinkedInPostingsDateDiagnostics.csv
    outputs/A02_Industry_BioPharm/E01_LinkedInPostingsMonthly.png
...
PATH_POSTINGS = DATA_DIRECTORY / "BioPharm_LinkedInPostings.parquet"
PATH_MONTHLY_COUNTS = OUTPUT_DIRECTORY / "E01_LinkedInPostingsMonthly.csv"
PATH_DATE_DIAGNOSTICS = OUTPUT_DIRECTORY / "E01_LinkedInPostingsDateDiagnostics.csv"
PATH_FIGURE = OUTPUT_DIRECTORY / "E01_LinkedInPostingsMonthly.png"
...
for postings_batch in iterate_parquet_batches(
    ...
    postings_batch["post_date"], diagnostic = convert_date_with_diagnostics(
        ...
        variable="post_date",
        dataset="BioPharm_LinkedInPostings",
    )
...
"""
Notes:
(1) The CSV retains all available monthly counts from the LinkedIn extract.
...
save_monthly_line(
    ...
    title="Monthly LinkedIn postings by biotechnology and pharmaceuticals companies",
    path=PATH_FIGURE,
)
