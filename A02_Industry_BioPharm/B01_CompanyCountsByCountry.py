"""
Task:
    Count BioPharm companies and plot the 30 largest headquarters-country groups.
...
Outputs:
    outputs/A02_Industry_BioPharm/B01_CompanyCountsByCountry.csv
    outputs/A02_Industry_BioPharm/B01_CompanyCountsByCountry.png

Run:
    conda activate Talent
    python codes/A02_Industry_BioPharm/B01_CompanyCountsByCountry.py
...
print(f"Total number of BioPharm companies: {total_companies:,}")
