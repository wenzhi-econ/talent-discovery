"""
Task:
    Plot monthly LinkedIn postings for Scientist and Engineer jobs at BioPharm firms.

Inputs:
    data/b_temp_data/A02_Industry_BioPharm/BioPharm_LinkedInPostings.parquet

Outputs:
    outputs/A02_Industry_BioPharm/E02_LinkedInFocalPostingsMonthly.csv
    outputs/A02_Industry_BioPharm/E02_LinkedInFocalPostingsDateDiagnostics.csv
    outputs/A02_Industry_BioPharm/E02_LinkedInFocalPostingsMonthly.png
...
save_monthly_line(
    ...
    title=(
        "Monthly LinkedIn Scientist and Engineer postings by biotechnology and "
