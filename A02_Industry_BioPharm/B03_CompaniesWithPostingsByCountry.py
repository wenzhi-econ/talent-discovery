...
Outputs:
    outputs/A02_Industry_BioPharm/B03_FirmPostingCounts_2021_2022.csv
    outputs/A02_Industry_BioPharm/B03_PostingDateDiagnostics.csv
    outputs/A02_Industry_BioPharm/B03_CompaniesWithPostingsByCountry.csv
    outputs/A02_Industry_BioPharm/B03_CompaniesWithPostingsByCountry.png
...
POSTING_PATHS = {
    "LinkedIn": DATA_DIRECTORY / "BioPharm_LinkedInPostings.parquet",
    "Indeed": DATA_DIRECTORY / "BioPharm_IndeedPostings.parquet",
}
...
for source, posting_path in POSTING_PATHS.items():
    for postings_batch in iterate_parquet_batches(
        ...
        postings_batch["post_date"], diagnostic = convert_date_with_diagnostics(
            ...
            variable="post_date",
            dataset=f"BioPharm_{source}Postings",
        )
