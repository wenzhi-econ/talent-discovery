"""
Task:
    Identify active BioPharm firms and plot the 30 largest country groups.
...
Outputs:
    outputs/A02_Industry_BioPharm/B04_ActiveFirmCounts.csv
    outputs/A02_Industry_BioPharm/B04_ActiveCompaniesByCountry.csv
    outputs/A02_Industry_BioPharm/B04_ActiveCompaniesByCountry.png
...
print(f"Total number of active BioPharm companies: {number_of_active_firms:,}")
