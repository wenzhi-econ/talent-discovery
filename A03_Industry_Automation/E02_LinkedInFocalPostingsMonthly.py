"""
Task:
    Plot monthly LinkedIn postings for Scientist and Engineer jobs at Automation firms.

Inputs:
    data/b_temp_data/A03_Industry_Automation/Automation_LinkedInPostings.parquet

Outputs:
    outputs/A03_Industry_Automation/E02_LinkedInFocalPostingsMonthly.csv
    outputs/A03_Industry_Automation/E02_LinkedInFocalPostingsDateDiagnostics.csv
    outputs/A03_Industry_Automation/E02_LinkedInFocalPostingsMonthly.png
...
save_monthly_line(
    ...
    title=(
        "Monthly LinkedIn Scientist and Engineer postings by automation companies"
    ),
    path=PATH_FIGURE,
)
