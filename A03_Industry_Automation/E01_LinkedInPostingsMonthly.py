"""
Task:
    Plot the monthly number of LinkedIn postings by Automation firms.

Inputs:
    data/b_temp_data/A03_Industry_Automation/Automation_LinkedInPostings.parquet

Outputs:
    outputs/A03_Industry_Automation/E01_LinkedInPostingsMonthly.csv
    outputs/A03_Industry_Automation/E01_LinkedInPostingsDateDiagnostics.csv
    outputs/A03_Industry_Automation/E01_LinkedInPostingsMonthly.png
...
PATH_POSTINGS = DATA_DIRECTORY / "Automation_LinkedInPostings.parquet"
...
for postings_batch in iterate_parquet_batches(
    ...
    postings_batch["post_date"], diagnostic = convert_date_with_diagnostics(
        ...
        variable="post_date",
        dataset="Automation_LinkedInPostings",
    )
...
save_monthly_line(
    ...
    title="Monthly LinkedIn postings by automation companies",
    path=PATH_FIGURE,
)
