"""
Task:
    Count Automation companies and plot the 30 largest headquarters-country groups.

Inputs:
    data/b_temp_data/A03_Industry_Automation/Automation_Companies.parquet

Outputs:
    outputs/A03_Industry_Automation/B01_CompanyCountsByCountry.csv
    outputs/A03_Industry_Automation/B01_CompanyCountsByCountry.png

Run:
    conda activate Talent
    python codes/A03_Industry_Automation/B01_CompanyCountsByCountry.py
...
print(f"Total number of Automation companies: {total_companies:,}")
