"""
Task:
    Plot monthly Indeed postings for Scientist and Engineer jobs at Automation firms.

Inputs:
    data/b_temp_data/A03_Industry_Automation/Automation_IndeedPostings.parquet

Outputs:
    outputs/A03_Industry_Automation/D02_IndeedFocalPostingsMonthly.csv
    outputs/A03_Industry_Automation/D02_IndeedFocalPostingsDateDiagnostics.csv
    outputs/A03_Industry_Automation/D02_IndeedFocalPostingsMonthly.png
...
save_monthly_line(
    ...
    title=(
        "Monthly Indeed Scientist and Engineer postings by automation companies"
    ),
    path=PATH_FIGURE,
)
