...
Outputs:
    ...
    outputs/A03_Industry_Automation/B02_EmployeeDateDiagnostics.csv
    outputs/A03_Industry_Automation/B02_CompaniesWithEmployeesByCountry.csv
    outputs/A03_Industry_Automation/B02_CompaniesWithEmployeesByCountry.png
