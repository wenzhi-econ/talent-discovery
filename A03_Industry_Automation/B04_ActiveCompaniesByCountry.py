"""
Task:
    Identify active Automation firms and plot the 30 largest country groups.

Inputs:
    outputs/A03_Industry_Automation/B02_FirmEmployeeCounts_2022_12.csv
    outputs/A03_Industry_Automation/B03_FirmPostingCounts_2021_2022.csv

Outputs:
    outputs/A03_Industry_Automation/B04_ActiveFirmCounts.csv
    outputs/A03_Industry_Automation/B04_ActiveCompaniesByCountry.csv
    outputs/A03_Industry_Automation/B04_ActiveCompaniesByCountry.png
...
print(f"Total number of active Automation companies: {number_of_active_firms:,}")
