"""
Task:
    Plot the December 2022 employee-count distribution across employing Automation firms.

Inputs:
    outputs/A03_Industry_Automation/B02_FirmEmployeeCounts_2022_12.csv

Outputs:
    outputs/A03_Industry_Automation/C01_EmployeeDistributionAllCompanies.png
...
save_integer_histogram(
    ...
    title=(
        "The distribution of observed firm size in December 2022 across automation companies"
    ),
