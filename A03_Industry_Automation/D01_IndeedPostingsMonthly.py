"""
Task:
    Plot the monthly number of Indeed postings by Automation firms.

Inputs:
    data/b_temp_data/A03_Industry_Automation/Automation_IndeedPostings.parquet

Outputs:
    outputs/A03_Industry_Automation/D01_IndeedPostingsMonthly.csv
    outputs/A03_Industry_Automation/D01_IndeedPostingsDateDiagnostics.csv
    outputs/A03_Industry_Automation/D01_IndeedPostingsMonthly.png
...
PATH_POSTINGS = DATA_DIRECTORY / "Automation_IndeedPostings.parquet"
...
for postings_batch in iterate_parquet_batches(
    ...
    postings_batch["post_date"], diagnostic = convert_date_with_diagnostics(
        ...
        variable="post_date",
        dataset="Automation_IndeedPostings",
    )
...
save_monthly_line(
    ...
    title="Monthly Indeed postings by automation companies",
    path=PATH_FIGURE,
)
