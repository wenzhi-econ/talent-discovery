"""
Task:
    Plot eligible later new hires per matched posting under three link criteria.
...
Outputs:
(a) outputs/A01_BaselineUSBiopharma/ResultsD06_HiresPerMatchedPosting.png

Descriptions of outputs:
(1) Output (a) uses three panels to plot empirical cumulative distributions of eligible
    later-new-hire counts among matched candidate job postings.

Run:
    From the project root in the Talent environment:
    python -m codes.A01_BaselineUSBiopharma.ResultsD06_HiresPerMatchedPosting
...
OUTPUT_FILE = plot.OUTPUT_DIRECTORY / "ResultsD06_HiresPerMatchedPosting.png"
CRITERIA = [
...
# <>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>
# <> Step 2. Count eligible new hires for each candidate posting
# <>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>
...
required_columns = ["id_job"] + [column for _, column, _ in CRITERIA]
plot.require_columns(partner_counts, required_columns, name="Posting partner counts")
if partner_counts[required_columns].isna().any(axis=None):
    raise ValueError("Posting partner counts contain missing values.")
if not (
    ...
    raise AssertionError("Posting partner counts are not nested across criteria.")
...
if any(counts.empty for counts in matched_counts.values()):
    raise ValueError("Every link criterion must match at least one candidate posting.")
summary_statistics = {}
...
for panel_index, (axis, (label, _, color)) in enumerate(zip(axes, CRITERIA, strict=True)):
    ...
    if panel_index == 0:
        axis.set_ylabel("Cumulative share of matched postings", fontsize=12)
...
figure.suptitle("Matched new hires per matched job posting", fontsize=20, y=0.97)
figure.supxlabel("Number of matched new hires", fontsize=12.5, y=0.275)
figure.text(
    0.06,
    0.055,
    "\n".join(summary_rows),
...
# <>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>
# <> Step 4. Report the saved new-hire-count distributions
# <>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>


project.finish_run(
    run,
    "Compared hires per matched posting under three nested link criteria.",
