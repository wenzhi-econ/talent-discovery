"""
Task:
(1) Inspect the Revelio ``postings_linkedin`` table in Microsoft Fabric.
...
"""
DATASET_NAME = "postings_linkedin"
OUTPUT_TABLE_NAME = "z_universe_roles_linkedin"
OUTPUT_ROLE_UNIVERSE = "Files/WenzhiW/List_StandardizedRoles_InLinkedInPostings"
SAMPLE_SIZE = 1000
OUTPUT_SAMPLE_TABLE = "z_sample_postings_linkedin"
OUTPUT_SAMPLE = "Files/WenzhiW/Sample_LinkedInPostings"


# <>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>
# <> Step 1. Read the LinkedIn posting data and select validated columns
# <>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>#<>


spark = SparkSession.builder.getOrCreate()
postings_linkedin = spark.read.table(DATASET_NAME)
postings_linkedin = postings_linkedin.select(
    "job_id",
    "rcid",
    "company",
    "rics_k50",
...
DATASET_SPEC = {
    "unit_of_observation": "One individual job posting collected from LinkedIn",
...
for field in postings_linkedin.schema.fields:
    print(
        f"  - {field.name}\n"
...
role_universe = postings_linkedin.select(*ROLE_VARIABLES).dropDuplicates()
...
sample_data = postings_linkedin.limit(SAMPLE_SIZE)
