"""
Task:
    Plot the December 2022 focal-employee distribution across employing Electronics firms.

Inputs:
    data/b_temp_data/A04_Industry_Electronics/Electronics_Companies.parquet
    data/b_temp_data/A04_Industry_Electronics/Electronics_UserPositions_FocalSpells.parquet

Outputs:
    outputs/A04_Industry_Electronics/C03_FirmFocalEmployeeCounts_2022_12.csv
    outputs/A04_Industry_Electronics/C03_FocalEmployeeDateDiagnostics.csv
    outputs/A04_Industry_Electronics/C03_FocalEmployeeDistributionAllCompanies.png
...
PATH_POSITIONS = DATA_DIRECTORY / "Electronics_UserPositions_FocalSpells.parquet"
...
for positions_batch in iterate_parquet_batches(
    ...
    positions_batch["startdate"], start_diagnostic = convert_date_with_diagnostics(
        ...
        variable="startdate",
        dataset="Electronics_UserPositions_FocalSpells",
    )
