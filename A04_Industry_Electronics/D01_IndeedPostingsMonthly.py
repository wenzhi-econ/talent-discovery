"""
Task:
    Plot the monthly number of Indeed postings by Electronics firms.

Inputs:
    data/b_temp_data/A04_Industry_Electronics/Electronics_IndeedPostings.parquet

Outputs:
    outputs/A04_Industry_Electronics/D01_IndeedPostingsMonthly.csv
    outputs/A04_Industry_Electronics/D01_IndeedPostingsDateDiagnostics.csv
    outputs/A04_Industry_Electronics/D01_IndeedPostingsMonthly.png
...
PATH_POSTINGS = DATA_DIRECTORY / "Electronics_IndeedPostings.parquet"
...
for postings_batch in iterate_parquet_batches(
    ...
    postings_batch["post_date"], diagnostic = convert_date_with_diagnostics(
        ...
        variable="post_date",
        dataset="Electronics_IndeedPostings",
    )
...
"""
Notes:
(1) The CSV retains only months observed in the extract, including isolated records before 2018.
...
save_monthly_line(
    ...
    title="Monthly Indeed postings by electronics companies",
    path=PATH_FIGURE,
)
