...
Outputs:
    ...
    outputs/A04_Industry_Electronics/B03_PostingDateDiagnostics.csv
    outputs/A04_Industry_Electronics/B03_CompaniesWithPostingsByCountry.csv
    outputs/A04_Industry_Electronics/B03_CompaniesWithPostingsByCountry.png
...
POSTING_PATHS = {
    "LinkedIn": DATA_DIRECTORY / "Electronics_LinkedInPostings.parquet",
    "Indeed": DATA_DIRECTORY / "Electronics_IndeedPostings.parquet",
}
...
for source, posting_path in POSTING_PATHS.items():
    for postings_batch in iterate_parquet_batches(
        ...
        postings_batch["post_date"], diagnostic = convert_date_with_diagnostics(
            ...
            variable="post_date",
            dataset=f"Electronics_{source}Postings",
        )
