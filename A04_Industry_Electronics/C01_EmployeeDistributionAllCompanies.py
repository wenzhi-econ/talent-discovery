"""
Task:
    Plot the December 2022 employee-count distribution across employing Electronics firms.

Inputs:
    outputs/A04_Industry_Electronics/B02_FirmEmployeeCounts_2022_12.csv

Outputs:
    outputs/A04_Industry_Electronics/C01_EmployeeDistributionAllCompanies.png
...
save_integer_histogram(
    ...
    title=(
        "The distribution of observed firm size in December 2022 across electronics companies"
    ),
