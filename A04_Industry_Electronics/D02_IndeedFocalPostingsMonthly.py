"""
Task:
    Plot monthly Indeed postings for Scientist and Engineer jobs at Electronics firms.

Inputs:
    data/b_temp_data/A04_Industry_Electronics/Electronics_IndeedPostings.parquet

Outputs:
    outputs/A04_Industry_Electronics/D02_IndeedFocalPostingsMonthly.csv
    outputs/A04_Industry_Electronics/D02_IndeedFocalPostingsDateDiagnostics.csv
    outputs/A04_Industry_Electronics/D02_IndeedFocalPostingsMonthly.png

Notes:
(1) Focal postings have job category Scientist or Engineer.
(2) The time series uses every successfully parsed posting date in the extract.
...
PATH_MONTHLY_COUNTS = OUTPUT_DIRECTORY / "D02_IndeedFocalPostingsMonthly.csv"
PATH_DATE_DIAGNOSTICS = OUTPUT_DIRECTORY / "D02_IndeedFocalPostingsDateDiagnostics.csv"
PATH_FIGURE = OUTPUT_DIRECTORY / "D02_IndeedFocalPostingsMonthly.png"
...
for postings_batch in iterate_parquet_batches(
    ...
    posting_batches.append(
        postings_batch.loc[focal_category, ["job_id", "post_date"]].dropna().drop_duplicates()
    )
...
save_monthly_line(
    ...
    title=(
        "Monthly Indeed Scientist and Engineer postings by electronics companies"
    ),
    path=PATH_FIGURE,
)
