...
Outputs:
    ...
    outputs/A04_Industry_Electronics/B02_EmployeeDateDiagnostics.csv
    outputs/A04_Industry_Electronics/B02_CompaniesWithEmployeesByCountry.csv
    outputs/A04_Industry_Electronics/B02_CompaniesWithEmployeesByCountry.png
