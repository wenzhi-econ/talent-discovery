"""
Task:
    Plot the monthly number of LinkedIn postings by Electronics firms.

Inputs:
    data/b_temp_data/A04_Industry_Electronics/Electronics_LinkedInPostings.parquet

Outputs:
    outputs/A04_Industry_Electronics/E01_LinkedInPostingsMonthly.csv
    outputs/A04_Industry_Electronics/E01_LinkedInPostingsDateDiagnostics.csv
    outputs/A04_Industry_Electronics/E01_LinkedInPostingsMonthly.png
...
save_monthly_line(
    ...
    title="Monthly LinkedIn postings by electronics companies",
    path=PATH_FIGURE,
)
